...
//     if (!error) {
//       try {
//         const paymentResponse = await axios.post('http://localhost:5001/api/registration/payment', {
//           token,
//           amount
//         });

//         if (paymentResponse.status === 200) {
//           const registrationResponse = await axios.post('http://localhost:5001/api/registration', {
//             name,
//             email,
//             ticketType
//           });
